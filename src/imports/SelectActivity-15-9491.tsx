import svgPaths from "./svg-24rkcplway";

function Content() {
  return (
    <div className="basis-0 content-stretch flex gap-[8px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Content">
      <div className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[16px]">
        <p className="leading-[24px]">Solar Energy FZCO</p>
      </div>
    </div>
  );
}
...
function Ring() {
  return (
    <div className="absolute inset-[4.8px]" data-name="Ring">
      <div className="absolute inset-[-5.556%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97 97">
          <g id="Ring">
            <path d={svgPaths.p3c1ffd00} id="Background" stroke="var(--stroke-0, #F2F4F7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="9.6" />
            <path d={svgPaths.p36902180} id="Line" stroke="var(--stroke-0, #7F56D9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="9.6" />
          </g>
        </svg>
      </div>
    </div>
...
function ProgressCircle() {
  return (
    <div className="relative shrink-0 size-[96px]" data-name="Progress circle">
      <Ring />
    </div>
  );
}
...
function Frame160() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-center min-h-px min-w-px relative shrink-0 w-full">
      <Frame163 />
      <ProgressCircle />
      <div className="font-['Inter:Regular',_sans-serif] font-normal leading-[0] min-w-full not-italic relative shrink-0 text-[#101828] text-[16px] text-center" style={{ width: "min-content" }}>
        <p className="leading-[24px]">Checking</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-tl-[20px] rounded-tr-[20px] shrink-0 w-full">
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[20px] items-center pb-[24px] pt-[12px] px-[16px] relative size-full">
...
export default function SelectActivity() {
  return (
    <div className="bg-[rgba(0,0,0,0.48)] box-border content-stretch flex flex-col items-center justify-end pb-0 pt-[96px] px-0 relative size-full" data-name="Select activity">
      <Frame5 />
    </div>
  );
}